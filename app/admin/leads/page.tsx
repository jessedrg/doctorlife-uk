...
/** Normaliza un teléfono a dígitos para wa.me. Si no lleva prefijo, asume España (34). */
                ...
                <td className="px-4 py-3">
                  {l.phone ? (
                    <a
                      ...
                      className="inline-flex items-center gap-1.5 rounded-full bg-[#25D366] px-3 py-1.5 text-[13px] font-medium text-white transition-opacity hover:opacity-90"
                      aria-label={`Abrir WhatsApp con ${l.phone}`}
                    >
