...
export const metadata: Metadata = {
  title: `Medical team — authors and reviewers | ${BRAND}`,
  description:
        ...
        <main>
          <div className="mx-auto max-w-[820px] px-5 pb-4 pt-10">
            ...
            <div className="pb-4 pt-12">
              <CTABlock variant="form" source="authors:index" />
            </div>
          </div>
        </main>
        <Footer />
      ...
      <JsonLd
        data={[
          breadcrumbSchema([
            ...
            { name: "Authors", url: URL },
          ]),
          itemListSchema(
            authors.map((a) => ({ name: a.name, url: `${SITE_URL}/authors/${a.slug}` })),
          ),
        ]}
      />
    </QuizProvider>
