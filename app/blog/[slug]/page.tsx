      ...
      <div className="overflow-x-clip bg-paper">
        ...
        <main>
          ...
          <article className="mx-auto max-w-[760px] px-5 pb-4 pt-2 lg:max-w-[820px] 2xl:max-w-[900px]">
            ...
            <BlogFunnel title="¿List@ para empezar?" subtitle="Reserva tu primera visita por 25 € (descontables del tratamiento) y empieza con un plan diseñado en torno a ti." />
